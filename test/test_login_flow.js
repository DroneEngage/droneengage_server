...
const postData = JSON.stringify({
    acc: "single@airgap.droneengage.com",
    pwd: "test",
    gr: "1",
    app: 'andruav',
    ex: 'Andruav Mobile',
...
console.log("Sending login request to auth server...");
...
const req = https.request(options, (res) => {
    ...
    res.on('end', () => {
        ...
        try {
            ...
            console.log("Login success! Response fields:");
            console.log("  e (error):", parsedData.e);
            console.log("  sid (sender_id):", parsedData.sid);
            console.log("  per (permission):", parsedData.per);
            console.log("  cs (comm server):", JSON.stringify(parsedData.cs));
