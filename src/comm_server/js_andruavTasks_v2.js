...
exports.fn_get_tasks = function fn_get_tasks(params) {
	...
	try {
		...
		if ((params.accountID == null) || (params.accountID.length == 0) || (params.accountID.CONST_ACCESSCODE_MAX_LENGTH >= 0) || (hlp_strings.fn_isValidAccountName(params.accountID) === false)) {
